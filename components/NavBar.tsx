...
function NavBar() {
  return (
      <nav id="navbar" className="fixed top-0 bg-black h-10 z-50 w-screen opacity-0 fade-in">
        <div className="grid grid-cols-5 justify-center items-center gap-0 lg:mx-025 h-full">
          ...
          <div className="flex justify-center self-center place-content-center">
            <img id="nav-logo" className="absolute z-50 w-16 h-16 md:w-28 md:h-28 top-0 opacity-0"
